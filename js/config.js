...
export const TOOL_HINTS = {
  ...
  stance_blitzkrieg: "WWII: блицкриг — быстрый клин в центр",
  stance_kessel: "WWII: котёл — двойной охват и сжатие",
  stance_depth_defense: "WWII: эшелонированная оборона",
  stance_barrage: "WWII: артподготовка, затем штурм",
  stance_partisans: "WWII: партизаны — удар и отход в лес",
  stance_attrition: "WWII: война на истощение",
  stance_elastic: "WWII: эластичная оборона и контрудар",
  stance_night_raid: "WWII: ночной удар по тылам",
  stance_interdiction: "WWII: блокада снабжения (фермы)",
  stance_shock: "WWII: штурмовые группы",
